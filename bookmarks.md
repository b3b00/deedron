...
# Debugging CSharp in Neovim with nvim-dap
...
![The Roslyn .NET compiler provides CSharp and Visual Basic languages with rich code analysis APIs. - dotnet/roslyn](https://opengraph.githubassets.com/31a6920eb83e00e3fb79f3a92f3084ddb11f814b90d4525e0904c8a8d89e22e2/dotnet/roslyn)
The Roslyn .NET compiler provides CSharp and Visual Basic languages with rich code analysis APIs. - dotnet/roslyn

[CSharp] [nuget] [source generators]

# Advanced Logging with Proxies in CSharp
...
This article presents a lightweight, dependency-free logging mechanism in CSharp using the DispatchProxy class. It enables efficient method interception, conditional logging, performance optimization, and error handling without external dependencies.

[CSharp] [.net]

# From CSharp to Rust: A Journey Through Code and Concepts - Chris Woody Woodruff | Fractional Architect
...
Welcome to my epic blog series, where we pit CSharp against Rust in a friendly, code-slinging showdown! If you’re a CSharp developer curious about Rust’s quirks and power or a Rustacean interested in how your language compares to the polished .NET ecosystem, you’ve come to the right place.
...
The CSharp Dev Kit team replaced C++ Node.js addons with CSharp and Native AOT, removing a dependency on Python. This post walks through building a Node.js native addon entirely in CSharp using N-API, LibraryImport, and UnmanagedCallersOnly.

[CSharp] [.net] [Node] [Nodejs]
